  ...
  return (
    ...
    >
      ...
      <div className="space-y-4">
        ...
        <motion.button
          className="flex w-full items-center justify-center rounded-lg bg-slate-600 px-5 py-2.5 text-sm font-medium hover:bg-sky-700 focus:outline-none focus:ring-4 focus:ring-sky-300"
        ...
        <div className="flex items-center justify-center gap-2">
          ...
          <Link
            to={"/"}
            className="inline-flex items-center gap-2 text-sm font-medium text-white underline hover:text-sky-300 hover:no-underline"
          >
            Continue Shopping
            <MoveRight size={16} />
          </Link>
